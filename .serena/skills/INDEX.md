...
7. **Карточки** — разговорный стиль, примеры из Task Manager/RAG, никакого кода в тексте
8. **Карточки в CSV** — НЕ записывать в файл, пока пользователь не подтвердит («Записывай», «Сохрани», «Готово»)
